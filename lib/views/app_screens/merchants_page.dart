                        ...
                        return InkWell(
                          onTap: () {
                            AppNavigator.pushAndStackPage(
                              context,
                              page: HistoryPage(merchant: merchant),
                            );
                          },
                          child: FadeInMerchantCard(
                            merchant: merchant,
                            index: index,
                          ),
                        );
      ...
      child: Card(
        ...
        child: ListTile(
          ...
          leading: CircleAvatar(
            backgroundImage: NetworkImage(widget.merchant.merchantImage),
            radius: 28,
          ),
          title: CustomText(
            text: widget.merchant.merchantName,
            size: 18,
            weight: FontWeight.w600,
          ),
          subtitle: CustomText(
            text: widget.merchant.merchantDescription,
